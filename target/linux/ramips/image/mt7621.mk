...
#  KERNEL := kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb
#  IMAGE_SIZE := 32448k
#  SUPPORTED_DEVICES += hc952 hualink,hc952
#endef
...
define Device/hc952
  ...
  DEVICE_PACKAGES := kmod-ata-ahci kmod-sdhci-mt7620 kmod-usb3 \
		kmod-usb-ledtrig-usbport #\
		kmod-mt7915e kmod-mt76 -w#pad-wolfssl
  SUPPORTED_DEVICES +=hc952 hualink,hc952
endef
TARGET_DEVICES += hc952
...
#  DEVICE_VARIANT := 16M
#  DEVICE_DTS_CONFIG := config@1
#  DEVICE_PACKAGES += kmod-mt7915e kmod-usb3 hc952
#  KERNEL := kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb
#  IMAGE_SIZE := 15808k
#  SUPPORTED_DEVICES += hc841 hualink,hc841
#endef
#TARGET_DEVICES += hc841
